...
def Planet1_event6(health, skill_warfare):
    ...
    if action == ("1"):
        typingPrint(
            "\n\n This plant is an carnavor and you have fallen right in it's trap.")
        health -= plant_damage
        if health <= 0:
            typingPrint(
            ...
            typingPrint(
                "You managed to escape wiht your life \nYou have" + str(health) + "left")
